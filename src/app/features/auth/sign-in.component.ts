...
import { AmplifyAuthenticatorModule, AuthenticatorService } from '@aws-amplify/ui-angular';  // ^5.1.3
...
export class SignInComponent implements OnInit, OnDestroy {
  ...
  async ngOnInit() {
    ...
    // Sync check (no polling needed—Hub catches async changes)
...
// src/app/features/auth/sign-in/sign-in.component.ts with polling uncomment if needed
// import { Component, inject, OnInit, OnDestroy, signal } from '@angular/core';
// import { CommonModule } from '@angular/common';
